...
class BedrockHandler:
    ...
    @staticmethod
    def user_message(
        message: str, context: Optional[str], uploaded_pics: Optional[list]
    ) -> dict:
        context_message = (
            f"You are a helful support engineer, answer the following question based on the provided context: \n\n {context} \n\n "
            if context
            else ""
        )
        new_message = {
