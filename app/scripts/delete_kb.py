...
bedrock_agent_client = boto3_session.client('bedrock-agent', region_name=kb_info["region_name"])
s3_client = boto3.client('s3')
oss_client = create_os_client(kb_info["kb_info"], kb_info["region_name"])
aoss_client = boto3_session.client('opensearchserverless')

bedrock_agent_client.delete_data_source(dataSourceId = kb_info["ds_Id"], knowledgeBaseId=kb_info["kb_id"])
...
aoss_client.delete_security_policy(type="encryption", name=kb_info["encryption_policy_name"])
